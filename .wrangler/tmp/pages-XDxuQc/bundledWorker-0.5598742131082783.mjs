...
var ye = /* @__PURE__ */ __name((t, e, s) => e in t ? be(t, e, { enumerable: true, configurable: true, writable: true, value: s }) : t[e] = s, "ye");
var p = /* @__PURE__ */ __name((t, e, s) => ye(t, typeof e != "symbol" ? e + "" : e, s), "p");
var Nt = /* @__PURE__ */ __name((t, e, s) => e.has(t) || $t("Cannot " + s), "Nt");
var n = /* @__PURE__ */ __name((t, e, s) => (Nt(t, e, "read from private field"), s ? s.call(t) : e.get(t)), "n");
var x = /* @__PURE__ */ __name((t, e, s) => e.has(t) ? $t("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), "x");
var u = /* @__PURE__ */ __name((t, e, s, r) => (Nt(t, e, "write to private field"), r ? r.call(t, s) : e.set(t, s), s), "u");
var g = /* @__PURE__ */ __name((t, e, s) => (Nt(t, e, "access private method"), s), "g");
var Lt = /* @__PURE__ */ __name((t, e, s, r) => ({ set _(i) {
  u(t, e, i, s);
}, get _() {
  return n(t, e, r);
} }), "Lt");
var Ut = /* @__PURE__ */ __name((t, e, s) => (r, i) => {
  let a = -1;
  return o(0);
  async function o(d) {
...
var we = Symbol();
var Ee = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
...
var Oe = /* @__PURE__ */ __name((t) => _t(t, decodeURI), "Oe");
...
var rt = /* @__PURE__ */ __name((t, e, ...s) => (s.length && (e = rt(e, ...s)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "rt");
var te = /* @__PURE__ */ __name((t) => {
...
var It = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? _t(t, se) : t) : t, "It");
...
var Bt = /* @__PURE__ */ __name((t) => _t(t, se), "Bt");
var nt;
var S;
var F;
var ie;
...
var re = (Vt = class {
...
}, nt = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakSet(), ie = /* @__PURE__ */ __name(function(t) {
  const e = n(this, S)[0][this.routeIndex][1][t], s = g(this, F, Ht).call(this, e);
  return s && /\%/.test(s) ? Bt(s) : s;
}, "ie"), ae = /* @__PURE__ */ __name(function() {
  ...
  return t;
}, "ae"), Ht = /* @__PURE__ */ __name(function(t) {
  return n(this, S)[1] ? n(this, S)[1][t] : t;
}, "Ht"), U = /* @__PURE__ */ new WeakMap(), Vt);
var De = { Stringify: 1 };
var ne = /* @__PURE__ */ __name(async (t, e, s, r, i) => {
...
var Dt = /* @__PURE__ */ __name((t, e) => ({ "Content-Type": t, ...e }), "Dt");
var gt;
var vt;
var I;
var ot;
...
var _e = (Wt = class {
  ...
  constructor(t, e) {
    ...
    p(this, "html", (t2, e2, s) => {
      const r = /* @__PURE__ */ __name((i) => g(this, B, it).call(this, i, e2, Dt("text/html; charset=UTF-8", s)), "r");
...
}, gt = /* @__PURE__ */ new WeakMap(), vt = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), ot = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), bt = /* @__PURE__ */ new WeakMap(), lt = /* @__PURE__ */ new WeakMap(), ct = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), yt = /* @__PURE__ */ new WeakMap(), wt = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakSet(), it = /* @__PURE__ */ __name(function(t, e, s) {
...
var Ue = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "Ue");
var Gt = /* @__PURE__ */ __name((t, e) => {
  if ("getResponse" in t) {
...
var Be = (dt = class {
  ...
  route(e, s) {
    ...
    return s.routes.map((i) => {
      var o;
      let a;
      s.errorHandler === Gt ? a = i.handler : (a = /* @__PURE__ */ __name(async (d, c) => (await Ut([], s.errorHandler)(d, () => i.handler(d, c))).res, "a"), a[Le] = i.handler), g(o = r, w, W).call(o, i.method, i.path, a);
    }), this;
  }
  basePath(e) {
  ...
  mount(e, s, r) {
    let i, a;
    r && (typeof r == "function" ? a = r : (a = r.optionHandler, r.replaceRequest === false ? i = /* @__PURE__ */ __name((c) => c, "i") : i = r.replaceRequest));
    const o = a ? (c) => {
      const l = a(c);
    ...
    const d = /* @__PURE__ */ __name(async (c, l) => {
...
}, T = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakSet(), ce = /* @__PURE__ */ __name(function() {
...
}, "ce"), P = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ __name(function(e, s, r) {
...
}, "W"), Rt = /* @__PURE__ */ __name(function(e, s) {
  if (e instanceof Error) return this.errorHandler(e, s);
  throw e;
}, "Rt"), St = /* @__PURE__ */ __name(function(e, s, r, i) {
...
var de = [];
function Ge(t, e) {
  const s = this.buildAllMatchers(), r = /* @__PURE__ */ __name(((i, a) => {
...
}, G = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakMap(), Ot = /* @__PURE__ */ new WeakSet(), fe = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let s = t === y;
...
}, V = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakSet(), J = /* @__PURE__ */ __name(function(e, s, r, i) {
  const a = [];
...
var cs = /* @__PURE__ */ __name(async (t, e) => {
  let s;
...
var ds = /* @__PURE__ */ __name((t) => async function(s, r) {
  return ls({ ...t, getContent: /* @__PURE__ */ __name(async (a) => cs(a, { manifest: t.manifest, namespace: t.namespace ? t.namespace : s.env ? s.env.__STATIC_CONTENT : void 0 }), "getContent") })(s, r);
}, "ds");
var hs = /* @__PURE__ */ __name((t) => ds(t), "hs");
var et = new ue();
et.use("/api/*", es());
...
// ../.wrangler/tmp/bundle-2Y3cXj/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-2Y3cXj/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.5598742131082783.mjs.map
